...
/** Fleet Manager (FM) */
const FM_ROLES = [ROLE.FM];
/** Fleet Owner (FO) */
const FO_ROLES = [ROLE.FO];
/** Fleet Engineers */
...
/** Xpert Engineers */
const XE_FTE_ROLES = [ROLE.XE_FTE];

/** Digital-Edge Engineers */
const DEFTE_ROLES = [ROLE.DE_FTE];
...
const isDeFTE = (r) => hasRole(r, DEFTE_ROLES);
